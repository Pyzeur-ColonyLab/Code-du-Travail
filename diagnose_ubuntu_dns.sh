...
echo "=== Ubuntu DNS Diagnostic and Fix Script ==="
...
echo
echo "=== Final DNS Test ==="
echo "Testing multiple domains..."
for domain in google.com github.com ubuntu.com; do
    echo "Testing $domain:"
    nslookup $domain | grep -E "(Name:|Address:)"
    echo
done

echo "DNS configuration complete!"
echo "If you still have issues, check the backup file: /etc/resolv.conf.backup.*" 